...
project = 'EnrichmentMap'
copyright = '2018, Ruth Isserlin, Mike Kucera, Christian Lopes'
author = 'Ruth Isserlin, Mike Kucera, Christian Lopes'
...
html_logo = 'images/enrichmentmap_logo_mini_bg.png'
...
htmlhelp_basename = 'EnrichmentMapdoc'
